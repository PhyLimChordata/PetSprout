		...
		<>
			<SafeAreaView style={[styles(colors).headContainer]}>
				...
				<TouchableOpacity
					...
					onPress={() => handleAnimation('0%', height * 0.1, 1)}
				>
					<Animated.Image
						style={
							selected == 1
						...
						source={require('../resources/images/Evolutions/LegsSilhouette.png')}
					/>
				</TouchableOpacity>
				<TouchableOpacity
					disabled={selected != null}
					...
					onPress={() => handleAnimation(width * 0.15, height * -0.05, 2)}
				>
					<Animated.Image
						style={
							selected == 2
						...
						source={require('../resources/images/Evolutions/FinSilhouette.png')}
					/>
				</TouchableOpacity>
				<TouchableOpacity
					disabled={selected != null}
					...
					onPress={() => handleAnimation(width * -0.13, height * -0.05, 3)}
				>
					<Animated.Image
						style={
							selected == 3
						...
						source={require('../resources/images/Evolutions/WingSilhouette.png')}
					/>
				</TouchableOpacity>
				{selected != null && (
					<Animated.View
