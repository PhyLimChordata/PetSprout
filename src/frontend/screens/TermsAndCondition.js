...
function TermsAndCondition(props) {   
	...
	return (
		<SafeAreaView>
			<MenuHeader text='Terms and Condition' navigation={props.navigation}></MenuHeader>
			<View style={style.headContainer}>
				...
				<ScrollView style={style.scrollView} contentContainerStyle={style.container}>
                    ...
                    <Text style={style.text}>
                        Please review the terms and
                        conditions ("terms") carefully as
                        the following information regards
                        the use of your personal
                        information.</Text>
                    <Text style={style.textTitle}>B. Privacy</Text>
                    <Text style={style.text}>
                        You agree to allow HabiPets to use
                        your data for research purposes.
                        We will not distribute the
                        information in any public way.</Text>
