...
function PutHabits(props) {
	...
	const createHabit = () => {
		...
		fetch('http://localhost:5000:5000/api/v1.0.0/habit/create_habit', {
			method: 'POST',
			headers: {
	...
	const modifyHabit = () => {
		fetch(
			'http://localhost:5000:5000/api/v1.0.0/habit/change_habit/' +
				props.userHabitId +
				'/' +
				props.habitId,
			{
	...
	const deleteHabit = () => {
		fetch(
			'http://localhost:5000:5000/api/v1.0.0/habit/delete_habit/' +
				props.userHabitId +
				'/' +
				props.habitId,
			{
