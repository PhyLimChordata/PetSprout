...
exports.withStaticPlugin = (config, props) => {
    ...
    assert_1.default(!(pluginProps === null || pluginProps === void 0 ? void 0 : pluginProps._resolverError), `Plugin property '_resolverError' is a reserved property of \`withStaticPlugin\``);
    let withPlugin;
