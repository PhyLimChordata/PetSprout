...
function getExtensions(platforms, extensions, workflows) {
    ...
    assert_1.default(Array.isArray(platforms), 'Expected: `platforms: string[]`');
    assert_1.default(Array.isArray(extensions), 'Expected: `extensions: string[]`');
    assert_1.default(Array.isArray(workflows), 'Expected: `workflows: string[]`');
