...
exports.version = "17.0.3-experimental-014edf198";
...
function renderer_attach(hook, rendererID, renderer, global) {
  ...
  function clearErrorsAndWarnings() {
    ...
    var _iterator = renderer_createForOfIteratorHelper(fiberToErrorsMap.keys()),
        _step;
    ...
    var _iterator2 = renderer_createForOfIteratorHelper(fiberToWarningsMap.keys()),
        _step2;
  ...
  function onErrorOrWarning(fiber, type, args) {
    var message = format.apply(void 0, renderer_toConsumableArray(args)); // Note that by calling these functions we may be creating the ID for the first time.
  ...
  var debug = function debug(name, fiber, parentFiber) {
    ...
    if (__DEBUG__) {
      ...
      console.log("[renderer] %c".concat(name, " %c").concat(displayName, " (").concat(id, ") %c").concat(parentFiber ? "".concat(parentDisplayName, " (").concat(parentID, ")") : '', " %c").concat(extraString), 'color: red; font-weight: bold;', 'color: blue;', 'color: purple;', 'color: black;');
    }
  ...
  function isEffect(memoizedState) {
    return memoizedState !== null && renderer_typeof(memoizedState) === 'object' && memoizedState.hasOwnProperty('tag') && memoizedState.hasOwnProperty('create') && memoizedState.hasOwnProperty('destroy') && memoizedState.hasOwnProperty('deps') && (memoizedState.deps === null || shared_isArray(memoizedState.deps)) && memoizedState.hasOwnProperty('next');
  }
