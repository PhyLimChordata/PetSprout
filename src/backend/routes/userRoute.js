...
router.post("/sendBugReport",authentication,sendReportValidator,sendReport.sendBugReport);
router.post("/sendFeedbackReport",authentication,sendReportValidator,sendReport.sendFeedbackReport);
